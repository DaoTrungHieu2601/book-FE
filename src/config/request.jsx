...
export const requestUpdateCategory = async (id, data) => {
    const res = await request.post('/api/category/update', { id, ...data });
    return res.data;
};
...
export const requestReturnBook = async (data) => {
    const res = await request.post('/api/payments/request-return-book', data);
    return res.data;
};

// Return Request APIs
export const requestCreateReturnRequest = async (data) => {
    const res = await request.post('/api/return-request/create', data);
    return res.data;
};

export const requestGetUserReturnRequests = async () => {
    const res = await request.get('/api/return-request/user-requests');
    return res.data;
};

export const requestGetReturnRequestDetail = async (rmaNumber) => {
    const res = await request.get(`/api/return-request/detail/${rmaNumber}`);
    return res.data;
};

export const requestGetReturnableOrders = async () => {
    const res = await request.get('/api/return-request/returnable-orders');
    return res.data;
};

export const requestUpdateReturnStatus = async (rmaNumber, data) => {
    const res = await request.put(`/api/return-request/update-status/${rmaNumber}`, data);
    return res.data;
};

export const requestGetAllReturnRequests = async () => {
    const res = await request.get('/api/return-request/all');
    return res.data;
};
