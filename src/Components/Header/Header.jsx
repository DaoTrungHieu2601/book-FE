...
function Header() {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            // Chỉ đóng search results, không đóng user menu
                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <Link to="/">
                        <div className="flex-shrink-0 cursor-pointer">
                            <img
                                src="/src/assets/images/lovango.png"
                                alt="logo"
                    ...
                    <div className="flex items-center space-x-6">
                        {((dataUser && dataUser._id) || (dataUser && dataUser.id)) && (
                            <Link to="/cart">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <span className="font-medium hidden sm:block">
                                    {(dataUser && dataUser._id) || (dataUser && dataUser.id) ? (dataUser.fullName || dataUser.email || 'Người dùng') : 'Tài khoản'}
                                </span>
                                <ChevronDown
                                        ...
                                        {(dataUser && dataUser._id) || (dataUser && dataUser.id) ? (
                                            ...
                                            <>
                                                ...
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        console.log('Navigating to info-user');
                                                        navigate('/info-user');
